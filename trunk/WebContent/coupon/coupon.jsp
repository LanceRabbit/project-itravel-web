				 ...
				 jQuery.each(data,function(index,value) {
					...
					if(data.length!=0){
						if($("#userForCouponsUse").text()!=""){
							jQuery("#CouponModals").append("<div id='"+value.CouponId+"Modal' class='modal fade printCouponDiv'><ul name='couponList' class='thumbnails' style='list-style:none;'><li class='col-md-6 col-md-offset-3 clearfix'  style='float:left; margin-top:10px'><div class='thumbnail clearfix'><button type='button' class='close' data-dismiss='modal'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button><table style='margin-top:30px'><tr><td><div><img src='"+value.Image+"' style='width:430px; height:240px;margin-left:10px;' class='pull-left span2 clearfix'></div></td></tr><tr><td></td></tr><tr><td><div class='caption'><h4><p class='text-danger'>適用店家: "+value.SpotName+"</p></h4><h4><p>"+value.Description+"</p></h4><small><b class='text-danger'>截止日期: </b>"+value.ValidDate+"</small></div><input type='button' class='pull-right btPrintCoupon' name='printCoupon' value='列印'/></td></tr></table></div></li></ul></div>");
							jQuery("#CouponList").append("<ul name='couponList' class='thumbnails' style='list-style:none;'><li class='col-xs-4 clearfix '  style='float:left; margin-left:-10px'><div class='thumbnail effects clearfix' id='effect-6'><div class='img' style='margin-left:8px;margin-top:3px; width:280px ;height:200px;'><img src='"+value.Image+"' style='width:280px; height:200px;margin-right:10px;' class='pull-left span2 clearfix'><div class='overlay'><a href='#' class='expand hoverCouponImg' id='"+value.CouponId+"'>+</a></div></div></div></li></ul>");
						}else{
							jQuery("#CouponList").append("<ul name='couponList' class='thumbnails' style='list-style:none;'><li class='col-xs-4 clearfix '  style='float:left; margin-left:-10px'><div class='thumbnail effects clearfix' id='effect-6'><div class='img' style='margin-left:8px;margin-top:3px; width:280px ;height:200px;'><img src='<c:url value='/images/Coupons_Empty.jpg'/>' style='width:280px; height:200px;margin-right:10px;' class='pull-left span2 clearfix'><div class='overlay'><a href='#' class='expand hoverCouponImg' id='"+value.CouponId+"'>+</a></div></div></div></li></ul>");
						}
					}else{
						console.log("沒有折價券唷!");
					}
