...
@WebServlet("/controller/SearchSpotPaging")
public class SearchSpotPagingServlet extends HttpServlet {
...
//		PrintWriter writer = null;
		...
		try {
			...
			if(request.getParameter("pageNo") != null)
				pageNo = Integer.parseInt(request.getParameter("pageNo").trim()); //System.out.println("page no : " + pageNo);
...
//			}
			...
			// insert page info into array
			JSONObject jsonSpotPage = new JSONObject();
			jsonSpotPage.put("totalPageCount", totalPageCount);
			jsonSpots.put(jsonSpotPage);
